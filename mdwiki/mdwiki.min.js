...
i.bullet = /(?:[*+-]|\d+\.)/, i.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/, i.item = e(i.item, "gm")(/bull/g, i.bullet)(), i.list = e(i.list)(/bull/g, i.bullet)("hr", /\n+(?=(?: *[-*_]){3,} *(?:\n+|$))/)(), i._tag = "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:/|@)\\b", i.html = e(i.html)("comment", /<!--[\s\S]*?-->/)("closed", /<(tag)[\s\S]+?<\/\1>/)("closing", /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g, i._tag)(), i.paragraph = e(i.paragraph)("hr", i.hr)("heading", i.heading)("lheading", i.lheading)("blockquote", i.blockquote)("tag", "<" + i._tag)("def", i.def)(), i.normal = g({}, i), i.gfm = g({}, i.normal, {
    ...
    for (var c, d, e, f, g, h, j, k, l, a = a.replace(/^ +$/gm, ""); a;)
        if ((e = this.rules.newline.exec(a)) && (a = a.substring(e[0].length), e[0].length > 1 && this.tokens.push({
            ...
            text: e[3]
                    ...
                    for (a = a.substring(e[0].length), h = {
                        ...
                        type: "hr"
                            ...
                            j._inside = /(?:\[[^\]]*\]|[^\]]|\](?=[^\[]*\]))*/, j._href = /\s*<?(.*?)>?(?:\s+['"]([\s\S]*?)['"])?\s*/, j.link = e(j.link)("inside", j._inside)("href", j._href)(), j.reflink = e(j.reflink)("inside", j._inside)(), j.normal = g({}, j), j.pedantic = g({}, j.normal, {
                                ...
                                else if (f = this.rules.autolink.exec(a)) a = a.substring(f[0].length), "@" === f[2] ? (c = this.mangle(":" === f[1][6] ? f[1].substring(7) : f[1]), e = this.mangle("mailto:") + c) : (c = d(f[1]), e = c), g += '<a href="' + e + '">' + c + "</a>";
                                ...
                                function(a) {
                                    ...
                                    }), a.md.ConfigDfd = a.Deferred(), a.ajax({
                                        url: "config.json",
                                        dataType: "text"
                                    }).done(function(b) {
                                        try {
                                ...
                                function($) {
                                    ...
                                    function findActiveLinkTrigger() {
                                        ...
                                        a.each(function(a, b) {
                                            var c = getGimmickLinkParts($(b)); - 1 === activeLinkTriggers.indexOf(c.trigger) && activeLinkTriggers.push(c.trigger)
                                ...
                                function(a) {
                                    ...
                                    function d() {
                                        var b = 0,
                                        d = a.md.util.repeatUntil(40, function() {
                ...
                var b = Number(window.getComputedStyle(document.getElementById("md-left-column")).width.replace("px", "")) - Number(30);
    ...
    function k() {
        ...
        b.each(function() {
            ...
            var c = a(this),
            d = a(this).find("img").filter(function() {
    ...
    function m() {
        var b = "";
        b += '<hr><div class="scontainer">', b += '<div class="pull-right md-copyright-footer"> ', b += '<span id="md-footer-additional"></span>', b += '本Wiki程序使用 <a href="http://www.mdwiki.info">MDwiki</a> ', b += "&copy; Timo D&ouml;rr", b += "</div>", b += "</div>";
        var c = a(b);
...
function(a) {
    ...
    function c() {
		//add chinese support
        var b = ["note", "beachte","标注"],
        c = ["achtung", "attention", "warnung", "warning", "atención", "guarda", "advertimiento", "注意", "警告"],
        d = ["hint", "tipp", "tip", "hinweis", "提示"],
        e = b.concat(c);
        e = e.concat(d);
        var f = [];
...
function(a) {
    ...
    d = c + "_" + c.toUpperCase(),
    e = a('<div id="fb-root" />'),
    f = a.md.prepareLink("connect.facebook.net/" + d + "/all.js#xfbml=1", {
        forceHTTP: !0
    }),
...
function(a) {
    function b(b) {
        b.remove();
        var c = document.createElement("script");
        c.type = "text/javascript", c.src = a.md.prepareLink("cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS-MML_HTMLorMML", {
            forceHTTP: !0
...
function(a) {
    ...
    var b = [{
        name: "bootstrap",
        url: "extlib/css/bootswatch/bootstrap/bootstrap.min.css"
    }, {
        name: "cerulean",
        url: "extlib/css/bootswatch/cerulean/bootstrap.min.css"
    }, {
        name: "cosmo",
        url: "extlib/css/bootswatch/cosmo/bootstrap.min.css"
    }, {
        name: "custom",
        url: "extlib/css/bootswatch/custom/bootstrap.min.css"
    }, {
        name: "cyborg",
        url: "extlib/css/bootswatch/cyborg/bootstrap.min.css"
    }, {
        name: "darkly",
        url: "extlib/css/bootswatch/darkly/bootstrap.min.css"
    }, {
        name: "flatly",
        url: "extlib/css/bootswatch/flatly/bootstrap.min.css"
    }, {
        name: "journal",
        url: "extlib/css/bootswatch/journal/bootstrap.min.css"
    }, {
        name: "lumen",
        url: "extlib/css/bootswatch/lumen/bootstrap.min.css"
    }, {
        name: "paper",
        url: "extlib/css/bootswatch/paper/bootstrap.min.css"
    }, {
        name: "readable",
        url: "extlib/css/bootswatch/readable/bootstrap.min.css"
    }, {
        name: "sandstone",
        url: "extlib/css/bootswatch/sandstone/bootstrap.min.css"
    }, {
        name: "simplex",
        url: "extlib/css/bootswatch/simplex/bootstrap.min.css"
    }, {
        name: "slate",
        url: "extlib/css/bootswatch/slate/bootstrap.min.css"
    }, {
        name: "spacelab",
        url: "extlib/css/bootswatch/spacelab/bootstrap.min.css"
    }, {
        name: "superhero",
        url: "extlib/css/bootswatch/superhero/bootstrap.min.css"
    }, {
        name: "united",
        url: "extlib/css/bootswatch/united/bootstrap.min.css"
    }, {
        name: "yeti",
        url: "extlib/css/bootswatch/yeti/bootstrap.min.css"
    }],
    c = !1,
    d = {
        name: "Themes",
    ...
    f = function(c) {
        ...
        var f = a("style[id*=bootstrap]").length > 0;
            ...
            "bootstrap" === c.name && f || (a("style[id*=bootstrap]").remove(), a('<link rel="stylesheet" type="text/css">').attr("href", c.url).appendTo("head")), c.inverse === !0 ? (a("#md-main-navbar").removeClass("navbar-default"), a("#md-main-navbar").addClass("navbar-inverse")) : (a("#md-main-navbar").addClass("navbar-default"), a("#md-main-navbar").removeClass("navbar-inverse"))
        }, g = function(b, d, e) {
            ...
            window.localStorage.theme && (b = a.extend({
